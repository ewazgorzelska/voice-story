...
- Preference-driven story generation (child age, minimum and maximum duration, optional motif prompt)
- Audio story generation with progress indicator and teaser preview
